...
mod test {
    ...
    fn test_strip_whitespace() {
        ...
        assert_eq!(
            ...
            Ok(("answer".into(), NonZero::new(42).unwrap()))
        );
    }
    ...
    fn test_delimited() {
        assert_eq!(
            ...
            Ok(("".into(), NonZero::new(0x32).unwrap()))
        );
        assert_eq!(
            delimited(tag("[".into()), stdp::U32, tag("]".into())).parse("[0x32] nice".into()),
            Ok((" nice".into(), NonZero::new(0x32).unwrap()))
        );
        assert_eq!(
    ...
    fn test_key_value() {
        ...
        assert_eq!(
            ...
            Ok(("nice".into(), NonZero::new(32).unwrap()))
        );
    }
        ...
        assert_eq!(
            ...
            Ok((
                ...
                LogKind::App(AppLogKind::Journal(AppLogJournalKind::CreateUser {
                    user_id: "Steeve".into(),
                    authorized_capital: NonZero::new(10_000).unwrap()
                }))
            ))
        );
        assert_eq!(
